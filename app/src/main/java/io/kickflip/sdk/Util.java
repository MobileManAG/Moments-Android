...
public class Util {
     ...
     */
    public static SessionConfig createRTMPpSessionConfig(Context context, String target, int mHlsSegmentDuration) {
        ...
        SessionConfig config = new SessionConfig.Builder(outputPath, mHlsSegmentDuration)
...
/*
    public static SessionConfig create720pHLSSessionConfig(Context context, int mHlsSegmentDuration) {
...
*/
     ...
     * @return the resulting SessionConfig
     */
/*    public static SessionConfig create420pSessionConfig(Context context, String targer, int mHlsSegmentDuration) {
        String outputPath = new File(context.getFilesDir(), "index.m3u8").getAbsolutePath();
        SessionConfig config = new SessionConfig.Builder(outputPath, mHlsSegmentDuration)
                .withTitle(Util.getHumanDateString())
