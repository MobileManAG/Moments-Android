...
public class ButtonCustomFont extends Button {
    ...
    public ButtonCustomFont(android.content.Context context) {
        super(context);
        setCustomFont(context, null);
    }

    public ButtonCustomFont(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public ButtonCustomFont(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
